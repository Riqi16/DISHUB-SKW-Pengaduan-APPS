...
include '../config/koneksi.php';
	...
	if (isset($_POST['kirim_tanggapan'])) {
		...
		$query_tanggapan= mysqli_query($koneksi, "INSERT INTO tanggapan(id_pengaduan, tgl_tanggapan, tanggapan, id_petugas) VALUES ('$id_pengaduan','$tanggal','$tanggapan','$id_petugas') ");
		if ($tanggapan != NULL) {
...
<?php 
$query_data = mysqli_query($koneksi, "SELECT a.*, b.* FROM pengaduan a INNER JOIN masyarakat b ON a.nik=b.nik ORDER BY id_pengaduan DESC");
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<form action="edit_data.php" method="POST">
					...
					<div class="modal-body">
						<input type="hidden" name="id_pengaduan" class="form-control" value="<?php echo $data['id_pengaduan'] ?>">
						<p>Apakah kamu yakin ingin menghapus data <br> <?php echo $data['judul_laporan'] ?></p>
					</div>
					<div class="modal-footer">
