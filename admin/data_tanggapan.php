	...
	<div class="row">
		<div class="col-md-12 mt-3">
			<div class="card">
				...
				<div class="card-body">
					<a href="export_tanggapan.php" class="btn btn-success" target="_blnk">Export To Excel</a>
...
<!-- Modal Hapus -->
<?php 
$query_data = mysqli_query($koneksi, "SELECT a.*, b.* FROM tanggapan a INNER JOIN pengaduan b ON a.id_pengaduan=b.id_pengaduan");
		...
		<div class="modal-content">
			<form action="edit_data.php" method="POST"> 
				...
				<div class="modal-body">
						...
						<p>Apakah kamu yakin ingin menghapus Tanggapan <br> <?php echo $data['judul_laporan'] ?></p>
					</div>
