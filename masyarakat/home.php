		...
		<div class="col-md-12 mt-3">
			<div class="card123">
				...
				if (isset($_POST['kirim'])) {
					...
					$query = mysqli_query($koneksi, "INSERT INTO pengaduan(tgl_pengaduan, nik, judul_laporan, isi_laporan, foto, status) VALUES ('$tanggal','$nik','$judul_laporan','$isi_laporan','$nama_foto','$status')");
...
<?php 
$nik = $_SESSION['nik'];
$query_data = mysqli_query($koneksi, "SELECT * FROM pengaduan WHERE nik='$nik' ORDER BY id_pengaduan DESC");
